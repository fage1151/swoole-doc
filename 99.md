...
该mysql类依赖[pdo](http://php.net/manual/zh/book.pdo.php)和[pdo\_mysql](http://php.net/manual/zh/ref.pdo-mysql.php)两个扩展，缺少扩展会报```Undefined class constant 'MYSQL\_ATTR\_INIT\_COMMAND' in ....```错误。
